# angularJS1 — Licensing

angularJS1 uses a **dual-license model**: open source for the community,
...
angularJS1 is licensed under the
[GNU Affero General Public License v3.0](LICENSES/AGPLv3.txt) (AGPLv3).

This covers:
- All application source code and templates
...
1. Use angularJS1 commercially with **>50 users** and **>$5M revenue/year**
2. Distribute angularJS1 inside a product **without** releasing your source under AGPLv3
3. Offer angularJS1 as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer angularJS1
...
Open an issue: https://github.com/egkristi/angularJS1/issues
